...
describe("Contrast Function", () => {
  ...
  test.todo("returns 21:1 for black and white");
  test.todo("returns 1:1 for identical colors");
  test.todo("handles colors with alpha channel");
  test.todo("produces symmetrical results (A vs B = B vs A)");
});
