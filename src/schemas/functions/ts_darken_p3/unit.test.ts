/**
 * Unit tests for the Darken P3 function
 * Decreases lightness by interpolating each channel toward black in Display P3 space
 */
...
describe("Darken P3 Function", () => {
  describe("Schema Definition", () => {
    it("should have correct schema structure", async () => {
      const schema = (await getBundledSchema("ts_darken_p3", "function")) as FunctionSpecification;

      expect(schema.name).toBe("Darken P3");
      expect(schema.type).toBe("function");
      expect(schema.keyword).toBe("ts_darken_p3");
    });
  ...
  describe("Function Execution", () => {
    it("should darken a light color in P3 space", async () => {
